...
public class BasePage {
	...
	public static WebElement waitForElementToVisible(WebDriver driver, WebElement webElement, int seconds) {
...
public static WebElement waitForElementClickable(WebDriver driver, WebElement webElement, int seconds) {
